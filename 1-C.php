...
class Tampil1C extends Tampilizin { // Membuat kelas Tampil1C yang mewarisi dari Tampilizin

    public function tampilData() { // Fungsi untuk menampilkan data
        $data = mysqli_query($this->conn, "select * from permohonan_izin where(pangkat_jabatan = '1-C')"); // Mengambil permohonan izin dengan pangkat 1-C
...
$K1C = new Tampil1C(); // Membuat objek dari kelas Tampil1C
$data = $K1C->tampilData(); // Mengambil data permohonan izin
