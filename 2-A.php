...
class Tampil2A extends Tampilizin { // Membuat kelas Tampil2A yang mewarisi dari Tampilizin
    public function tampilData() { // Fungsi untuk menampilkan data
        $data = mysqli_query($this->conn, "select * from permohonan_izin where(pangkat_jabatan = '2-A')"); // Mengambil permohonan izin dengan pangkat 2-A
...
$K2A = new Tampil2A(); // Membuat objek dari kelas Tampil2A
$data = $K2A->tampilData(); // Mengambil data permohonan izin
